            ...
            <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
                <div class="card-body px-4 py-3">
                    <div class="row align-items-center">
                        <div class="col-9">
                            <h4 class="fw-semibold mb-8">Create Package</h4>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="card w-100 position-relative overflow-hidden">
                            ...
                            <form method="post" action="{{ route('admin.storepackage') }}" enctype="multipart/form-data">
                                @csrf
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-3">
                                                                ...
                                                                <input type="text" name="sightseeing" id="sightseeing"
                                                                    class="form-control @error('sightseeing') is-invalid @enderror"
