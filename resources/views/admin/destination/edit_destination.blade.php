        ...
        <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
                <div class="row align-items-center">
                    <div class="col-9">
                        <h4 class="fw-semibold mb-8">Edit Destination</h4>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item">
                                    <a class="text-muted text-decoration-none"
                                        href="{{ route('admin.viewdestination') }}">View Destinations</a>
                                </li>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="card w-100 position-relative overflow-hidden">
                        <form action="{{ route('admin.updatedestination',[$destination->id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                                ...
                                <div class="row m-auto">
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" class="form-control @error('location') is-invalid @enderror" name="destination" id="destination" value="{{ $destination->destination }}" placeholder="Enter Destination">
                                            @error('location')
                                                {{ $message }}
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-4">
                                            ...
                                            <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description" placeholder="Enter description"
                                                rows="3">{{ $destination->description }}</textarea>
                                            @error('description')
                                                {{ $message }}
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-12">
                                        <div class="mb-2">
                                            ...
                                            <input type="file" class="form-control @error('image') is-invalid @enderror" name="image" value="{{ $destination->image }}"  id="image">
                                            <img
                                                src="{{ asset('uploads/destination/'. $destination->image) }}"
                                                class="img-fluid rounded-top rounded-bottom mt-3" width="100px" height="100px"
                                                alt=""
                                            />
                                ...
                                <div class="d-flex flex-wrap gap-6 align-items-center">
                                   <div class="text-center">
                                            <button type="submit" class="btn bg-success-subtle text-success mb-2 active "  >
                                                ...
                                                <span class="text-active">Update</span>
                                            </button>
