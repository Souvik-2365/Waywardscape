    ...
    <div class="body-wrapper">
        <div class="container-fluid">
                ...
                <div class="card-body p-0">
                    ...
                    <ul class="nav nav-pills user-profile-tab justify-content-end mt-2 bg-primary-subtle rounded-2 rounded-top-0">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link position-relative rounded-0  d-flex align-items-center justify-content-center bg-transparent fs-3 py-6" type="button" onclick="window.location.href = '{{ route('admin.profile') }}'">
                        ...
                        <li class="nav-item" role="presentation">
                            <button
                                class="nav-link position-relative rounded-0 active d-flex align-items-center justify-content-center bg-transparent fs-3 py-6"type="button" aria-selected="true" onclick="window.location.href = '{{ route('admin.editprofile') }}'">
            ...
            <div>
                ...
                <div class="tab-pane fade show active"  aria-labelledby="pills-followers-tab" >
                    <div class="row">
