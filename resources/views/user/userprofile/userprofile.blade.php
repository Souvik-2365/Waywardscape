                            ...
                            <ul class="nav flex-column nav-pills" id="pills-tab" role="tablist">
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link" id="change-pass-tab" data-bs-toggle="pill"
                                        data-bs-target="#change-pass" type="button" role="tab"
                                        aria-controls="change-pass" aria-selected="false" tabindex="-1">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                            viewBox="0 0 14 14">
                        ...
                        <div class="tab-content w-100" id="pills-tabContent">
                            <div class="tab-pane fade active show" id="profile" role="tabpanel"
                                ...
                                @if (Session::get('error'))
                                    <div class="alert bg-primary-subtle text-primary alert-dismissible fade show"
                                        role="alert">
                                ...
                                <div class="dashboard-profile-tab-content">
                                        ...
                                        <div class="d-flex align-items-center justify-content-center mb-2">
                                            <div class="d-flex align-items-center justify-content-center round-100"
                                                ...
                                                <div
                                                    ...
                                                    <img src="{{ asset('uploads/profile/user/' . auth()->guard('web')->user()->image) }}"
                                                        style="overflow: hidden" alt="" class="w-100 h-100">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="profile-tab-content-title">
                                        <h6 class="mb-5">You Details</h6>
                                        <div class="row" style="padding-left: 100px; padding-right: 100px">
                                            <div class="col-md-6 mb-30">
                                                <h4>Name:</h4>
                                                <h6 class="fs-5 mb-0 fw-semibold">{{ auth()->guard('web')->user()->name }}
                                                </h6>
                                            </div>
                                            <div class="col-md-6 mb-30">
                                                <h4>Email:</h4>
                                                <h6 class="fs-5 mb-0 fw-semibold">{{ auth()->guard('web')->user()->email }}
                                                </h6>
                                            </div>
                                            <div class="col-md-6 mb-30">
                                                <h4>Phone:</h4>
                                                <h6 class="fs-5 mb-0 fw-semibold">
                                                    {{ auth()->guard('web')->user()->mobile }}</h6>
                                            </div>
                                            <div class="col-md-6 mb-30">
                                                <h4>Address:</h4>
                                                <h6 class="fs-5 mb-0 fw-semibold">
                                                    {{ auth()->guard('web')->user()->address }}</h6>
                                            </div>
                                            <div class="col-md-6 mb-30">
                                            </div>
                                        </div>
                                    ...
                                    <div class="profile-tab-content-title">
                                        <h6 class="mb-5">Change Details</h6>
                                        <form method="post" action="{{ route('updateuser') }}"
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-inner mb-30">
                                                        ...
                                                        <input type="email"
                                                            ...
                                                            name="email" readonly style="background-color: whitesmoke"
                                            ...
                                            <div class="upload-img-area-content">
                                                ...
                                                <p>Image should not exceed 250*250.</p>
                                            </div>
                                ...
                                <div class="dashboard-profile-tab-content">
                                    ...
                                    <table class="table border text-nowrap mb-0 align-middle ">
                                        <thead class="text-dark fs-4 text-center">
                                            <tr>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">payment id</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Name</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Email</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Start-End date</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Adult/Child</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Amount</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Status</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Payment Method</h6>
                                                </th>
                                                <th>
                                                    <h6 class="fs-6 fw-semibold mb-0">Booking Date</h6>
                                                </th>
                                            </tr>
                                        </thead>
                            ...
                            <div class="tab-pane fade" id="change-pass" role="tabpanel"
                                ...
                                <div class="dashboard-profile-tab-content">
                                    ...
                                    <div class="change-password-form-btns">
                                        ...
                                        <button type="cancel" class="primary-btn3 cancel">Cancel</button>
                                    </div>
                                </div>
                            </div>
                        </div>
