...
@section('content')
                ...
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <div class="home1-banner-wrapper"
                            style=" background-image: linear-gradient( 180deg, rgba(16, 12, 8, 0.4) 0%,rgba(16, 12, 8, 0.4) 100%),
                            url(https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/home1-banner-img1.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="home1-banner-content">
                                            ...
                                            <h1>Let's Travel And Explore
                                                Destination.</h1>
                                            <p>
                                                Life is unpredictable, and
                                                we understand that plans
                                                might change. Enjoy flexible
                                                booking options, so you
                                                can reschedule or modify
                                                your trip with ease.
                                            </p>
                                            <div class="banner-content-bottom">
                                                <a href="{{ route('package-sidebar') }}" class="primary-btn1">Book
                                                    A Trip</a>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="swiper-slide">
                        <div class="home1-banner-wrapper"
                            style="background-image: linear-gradient( 180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100% ), url(https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/home1-banner-img2.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="home1-banner-content">
                    ...
                    <div class="swiper-slide">
                        <div class="home1-banner-wrapper"
                            style=" background-image: linear-gradient(180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100% ),url(https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/home1-banner-img3.png);">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="home1-banner-content">
                                            ...
                                            <h2>Let's journey and discover a
                                                place.</h2>
                                            <p>
                                                Life is unpredictable, and
                                                we understand that plans
                    ...
                    <div class="swiper-slide">
                        <div class="home1-banner-wrapper"
                            style=" background-image: linear-gradient( 180deg, rgba(16, 12, 8, 0.4) 0%, rgba(16, 12, 8, 0.4) 100% ), url(https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/home1-banner-img4.png); ">
                            <div class="container">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="home1-banner-content">
                                            ...
                                            <h2>Let's trek and venture to a
                                                spot.</h2>
                                            <p>
                                                Life is unpredictable, and
                                                we understand that plans
            ...
            <div class="row">
                <div class="col-lg-12">
                            ...
                            <div class="swiper-slide">
                                <div class="destination-card2">
                                    <a href="{{ route('destination-details') }}" class="destination-card-img"><img
                                            src="{{ asset('uploads/destination/'. $destination->image) }}"
                                            alt /></a>
                                    <div class="batch">
                                        <span>5 Tour</span>
                                    </div>
                                    <div class="destination-card2-content">
                                        <span>Travel To</span>
                                        <h4><a href="{{ route('destination-details') }}">{{ $destination->destination }}</a></h4>
                                    </div>
                                </div>
                            </div>
                            @endforeach --}}
                                ...
                                <div class="swiper-slide">
                                    <div class="destination-card2">
                                        <a href="{{ route('destination-details',['id' => $destination->id]) }}" class="destination-card-img">
                                            <img src="{{ asset('uploads/destination/'. $destination->image) }}" alt="" style="width: 100%; height: 200px;" />
                                        ...
                                        <div class="destination-card2-content">
                                            <span>Travel To</span>
                                            <h4><a href="{{ route('destination-details',['id' => $destination->id]) }}">{{ Str::limit($destination->destination, '10', '...') }}</a></h4>
                                        </div>
                                    </div>
                                </div>
                            @endforeach
                            ...
                            {{-- <div class="swiper-slide">
                                <div class="destination-card2">
                                    ...
                                    <div class="destination-card2-content">
                                        <span>Travel To</span>
                                        <h4>
                                            <a href="{{ route('destination-details') }}">Switzerland</a>
                                        </h4>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="slide-and-view-btn-grp">
                        ...
                        <a href="{{ route('destination') }}" class="secondary-btn2">View
                            All Destination</a>
                    </div>
                </div>
            </div>
    ...
    <div class="package-card-section pt-120 mb-120">
        <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/section-vector1.png" alt
            class="section-vector1" />
        <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/section-vector3.png" alt
        ...
        <div class="container">
            ...
            {{-- @foreach ($packages->take(6) as $package)
                @php
                $packageImages = $packages->packageImages; // Access the packageImages relationship
                $firstImage = $packageImages->first(); // Get the first image
            @endphp
                <div class="col-lg-4 col-md-6">
                    <div class="package-card">
                        <div class="package-card-img-wrap">
                            <a href="{{ route('package-details',['id' => $package->id]) }}" class="card-img"><img
                                src="" alt="{{ $package->title }}" /></a>
            ...
            @endphp
            {{-- <h1>{{ $firstImage->image}}</h1>
            <img src="{{ asset('uploads/package/'.$firstImage->image)}}" alt="not"> --}}
            <div class="col-lg-4 col-md-6">
                <div class="package-card">
                    <div class="package-card-img-wrap">
                    ...
                    <div class="package-card-content">
                        <div class="card-content-top card-title">
                            <h5>
                                <a href="{{ route('package-details',['id' => $package->id]) }}">
                                    {{-- {{ Str::limit($package->title, '50', '...')  }}. --}}
                                    {{ $package->title }}
                                </a>
                            </h5>
                        </div>
                        <div class="card-content-bottom card-text">
                            <div class="price-area">
                                <h6>Starting From:</h6>
                                <span>${{ $package->discounted_price }}</span>
        ...
        @endforeach
            ...
            <div class="row">
                <div class="col-lg-12 d-flex justify-content-center">
                    <a href="{{ route('package-sidebar') }}" class="secondary-btn1">View
                        All Package</a>
                </div>
            </div>
        </div>
    ...
    <div class="franctional-slider-section">
        <div class="container-fluid p-0">
            <div class="row g-0">
                                ...
                                <div class="swiper-slide">
                                    <div class="slider-content">
                                        ...
                                        <p>
                                            ...
                                            Morbi porand gon nullalacu
                                            scelerisque in aliquam vitae,
                                            aliquam ut lectus. Nam utte mink
                                            Phasellus magna,
                                            efficitur finibus dictum auctor,
                                            volutpat gonet torrend
                                            accumsan purusDon luctus nunc
                                            non dapibus volutpat.
                                        </p>
                                        <ul>
                                            <li>
                ...
                <div class="col-lg-6">
                    <div class="franctional-slider-right-img">
                        <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/facility-img.png"
                            alt />
                        <div class="logo">
                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/icon/tripadvisor-logo2.svg "
                                alt />
                        </div>
                    </div>
                </div>
            ...
            <div class="rating-wrapper">
                <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/rating-img1.png" alt />
                <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/rating-img2.png" alt />
            </div>
        </div>
    </div>
    ...
    <div class="feature-card-section mb-120">
        <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/section-vector4.png" alt
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <div class="feature-card-content">
                            ...
                            <p>
                                Cras facilisis fermentum ex seda ullamcorper
                                odio rutrum
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card two">
                        ...
                        <div class="feature-card-content">
                            ...
                            <p>
                                Burabitur convallis enim atnora ullamcorper
                                sagittis. Morbi
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card three">
                        ...
                        <div class="feature-card-content">
                            <h6>Fast Booking</h6>
                            <p>
                                Fermentum eitorx quis maximum Etiam luctus
                                erat vulputate
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card three">
                        ...
                        <div class="feature-card-content">
                            <h6>Guided Tours</h6>
                            <p>
                                Pellentesque venenatis egestasoi diam Proin
                                velgorat elit
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card">
                        ...
                        <div class="feature-card-content">
                            ...
                            <p>
                                Sed venenatis mauris nec nulla euismod,
                                accounv varius lectus
                                viverra oncen.
                            </p>
                        </div>
                    </div>
                ...
                <div class="col-xl-4 col-md-6">
                    <div class="feature-card two">
                        ...
                        <div class="feature-card-content">
                            ...
                            <p>
                                Duis leo sapien, lacinia utorrent efficitur
                                utom suscipit quis
                                nulla Sed auctor eu
                            </p>
                        </div>
                        ...
                        <div class="verticle-tab-sidebar">
                            <ul class="nav nav-pills" id="pills-tab5" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link active" id="nature-tab" data-bs-toggle="pill"
                                        data-bs-target="#nature" role="tab" aria-controls="nature"
                                        aria-selected="true">
                                        <div class="icon">
                                ...
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link" id="boating-tab" data-bs-toggle="pill"
                                        data-bs-target="#boating" role="tab" aria-controls="boating"
                                        aria-selected="false">
                                        <div class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54"
                                                viewBox="0 0 54 54">
                                ...
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link" id="adventure-tab" data-bs-toggle="pill"
                                        data-bs-target="#adventure" role="tab" aria-controls="adventure"
                                        aria-selected="false">
                                        <div class="icon">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="54" height="54"
                                                viewBox="0 0 50 49">
                                                <g>
                                                    <path
                                                        d="M5.21479 0.298828C4.99018 0.494141 4.94136 0.630859 4.90229 1.13867C4.873 1.49023 4.91206 1.85156 4.98042 2.02734C5.29292 2.78906 6.52339 2.78906 6.83589 2.02734C6.90425 1.85156 6.94331 1.49023 6.91401 1.13867C6.85542 0.376953 6.57222 0.0742188 5.90815 0.0742188C5.59565 0.0742188 5.40034 0.142578 5.21479 0.298828Z" />
                                                    <path
                                                        d="M0.302734 3.16016C0.0488281 3.375 0 3.48242 0 3.85352C0 4.41992 0.0976562 4.58594 0.625 4.89844C1.24023 5.25977 1.77734 5.24023 2.1582 4.86914C2.70508 4.32227 2.48047 3.52148 1.65039 3.10156C1.12305 2.82813 0.664062 2.84766 0.302734 3.16016Z" />
                                                    <path
                                                        d="M10.1367 3.1016C9.62891 3.37504 9.375 3.73636 9.375 4.19535C9.375 5.07426 10.3516 5.44535 11.1816 4.88871C11.7188 4.52738 11.8066 4.39066 11.8164 3.90238C11.8164 3.04301 10.9961 2.65238 10.1367 3.1016Z" />
                                                    <path
                                                        d="M5.04888 3.19926C4.27739 3.39457 3.53521 3.88285 3.01763 4.53715C2.08013 5.70903 2.09966 7.74028 3.05669 8.95121C4.69732 11.0215 7.98833 10.6602 9.16021 8.27738C9.5313 7.52543 9.58013 6.23637 9.27739 5.41606C8.98442 4.63481 8.19341 3.79496 7.42192 3.45317C6.75786 3.15043 5.68364 3.04301 5.04888 3.19926ZM6.72857 5.41606C7.61724 6.08012 7.66607 7.2227 6.83599 7.91606C5.76177 8.82426 4.04302 7.71098 4.41411 6.34379C4.5313 5.92387 4.90239 5.47465 5.32232 5.2891C5.70317 5.11332 6.39653 5.17192 6.72857 5.41606Z" />
                                                    <path
                                                    ...
                                                    <path
                                                        d="M5.38086 11.0508C5.0293 11.2461 4.89258 11.5879 4.88281 12.2617C4.88281 12.8184 4.91211 12.916 5.16602 13.1699C5.54687 13.541 6.20117 13.5703 6.60156 13.2285C6.82617 13.0332 6.875 12.8965 6.91406 12.3887C6.94336 12.0371 6.9043 11.6758 6.83594 11.5C6.62109 10.9824 5.89844 10.7578 5.38086 11.0508Z" />
                                                    <path
                                                        d="M46.172 24.6934C45.9278 24.791 44.4435 26.5586 44.1603 27.0957C43.9552 27.4668 44.0235 27.877 44.3263 28.2187C44.5704 28.4922 44.6778 28.541 45.0489 28.541C45.5665 28.541 45.7423 28.4043 46.5528 27.3398L47.0997 26.6367H48.2521C49.3458 26.6367 49.4142 26.627 49.6974 26.3828C49.9513 26.168 50.0001 26.0605 50.0001 25.6895C50.0001 24.752 49.6681 24.5859 47.7833 24.5957C47.0411 24.5957 46.3185 24.6445 46.172 24.6934Z" />
                                                    <path
                                                        d="M42.168 29.5273C41.8164 29.7129 41.6992 29.9473 41.6992 30.4453C41.6992 30.7676 41.7578 30.9142 41.9824 31.1388C42.6172 31.7638 43.6523 31.334 43.6523 30.4453C43.6523 29.9375 43.5254 29.7031 43.1641 29.5176C42.8125 29.332 42.5098 29.332 42.168 29.5273Z" />
                                                </g>
                                            </svg>
                                        </div>
                                        <h6>Ski touring</h6>
                                ...
                                <li class="nav-item" role="presentation">
                                    <div class="nav-link" id="history-tab" data-bs-toggle="pill"
                            ...
                            <div class="tab-pane fade show active" id="nature" role="tabpanel"
                                ...
                                <div class="verticle-tab-content-wrap">
                                    <div class="verticle-tab-content">
                                        ...
                                        <h2>Thrill Above Ground: The Zip
                                            Line Adventure</h2>
                                        <p>
                                            Embark on an adrenaline-fueled
                                            journey, zipping through
                                            lush landscapes, feeling the
                                            wind rush past, and
                                            experiencing nature from
                                            breathtaking heights. Unleash
                                    ...
                                    <div class="verticle-tab-img">
                                        <div class="verticle-tab-img1 mb-25">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/zip-landing-01.jpg"
                                                alt />
                                        </div>
                                        <div class="verticle-tab-img2">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/zip-landing-02.jpg"
                                                alt />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="boating" role="tabpanel">
                                <div class="verticle-tab-content-wrap">
                                    <div class="verticle-tab-content">
                                        ...
                                        <h2>Plunge: Bungee Jumping's
                                            Gravity-Defying Thrill</h2>
                                        <p>
                                            Plunge into pure adrenaline.
                                            Free fall, then rebound,
                                            suspended mid-air. Experience
                                            the ultimate rush, a
                                            heart-pounding leap into the
                                            unknown.
                                        </p>
                                        <ul>
                                            <li>
                                    ...
                                    <div class="verticle-tab-img">
                                        <div class="verticle-tab-img1 mb-25">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/bungee-jump-01.jpg"
                                                alt />
                                        </div>
                                        <div class="verticle-tab-img2">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/bungee-jump-02.jpg"
                                                alt />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="cultural" role="tabpanel" aria-labelledby="cultural-tab">
                                <div class="verticle-tab-content-wrap">
                                    <div class="verticle-tab-content">
                                        ...
                                        <h2>Whitewater Rush: Thrilling
                                            Rafting Adventure</h2>
                                        <p>
                                            Ride through rapids, paddle
                                            through currents, and enjoy
                                            thrilling adventures with expert
                                            guides amidst stunning
                                    ...
                                    <div class="verticle-tab-img">
                                        <div class="verticle-tab-img1 mb-25">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/rafting-01.jpg"
                                                alt />
                                        </div>
                                        <div class="verticle-tab-img2">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/rafting-02.jpg"
                                                alt />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="adventure" role="tabpanel" aria-labelledby="adventure-tab">
                                <div class="verticle-tab-content-wrap">
                                    <div class="verticle-tab-content">
                                        ...
                                        <h2>
                                            Powder Quest: Exploring
                                            Snow-Covered Landscapes on Skis
                                        </h2>
                                        <p>
                                            Ski tour through pristine
                                            snowscapes, ascend peaks, and
                                            savor thrilling descents,
                                    ...
                                    <div class="verticle-tab-img">
                                        <div class="verticle-tab-img1 mb-25">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/ski-touring-01.jpg"
                                                alt />
                                        </div>
                                        <div class="verticle-tab-img2">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/ski-touring-02.jpg"
                                                alt />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="beach" role="tabpanel" aria-labelledby="beach-tab">
                                <div class="verticle-tab-content-wrap">
                                    <div class="verticle-tab-content">
                                        ...
                                        <h2>Horizon Dance: Unique
                                            Paragliding Perspectives.</h2>
                                        <p>
                                            Experience freedom in flight,
                                            soaring gracefully over
                                            landscapes, feeling the wind's
                                            embrace on an
                                            exhilarating paragliding
                                            escapade. Adventure awaits
                                            above!
                                        </p>
                                        <ul>
                                            <li>
                                    ...
                                    <div class="verticle-tab-img">
                                        <div class="verticle-tab-img1 mb-25">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/paragliding-01.jpg"
                                                alt />
                                        </div>
                                        <div class="verticle-tab-img2">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/paragliding-02.jpg"
                                                alt />
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="tab-pane fade" id="history" role="tabpanel" aria-labelledby="history-tab">
                                <div class="verticle-tab-content-wrap">
                                    <div class="verticle-tab-content">
                                        ...
                                        <h2>
                                            Ocean Rush: The Thrill of Riding
                                            Majestic Surf Waves.
                                        </h2>
                                        <p>
                                            Ride powerful waves, feel the
                                            ocean's rhythm, and
                                            embrace the thrill of surfing,
                                            blending athleticism and
                                            connection with nature's forces.
                                        </p>
                                        <ul>
                                            <li>
                                                <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9"
                                    ...
                                    <div class="verticle-tab-img">
                                        <div class="verticle-tab-img1 mb-25">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/surfing-01.jpg"
                                                alt />
                                        </div>
                                        <div class="verticle-tab-img2">
                                            <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/surfing-02.jpg"
                                                alt />
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="about-content">
                        ...
                        <ul class="nav nav-pills" id="pills-tab3" role="tablist">
                            ...
                            <li class="nav-item" role="presentation">
                                <button class="nav-link" id="focus-customer-tab" data-bs-toggle="pill"
                                    data-bs-target="#focus-customer" type="button" role="tab"
                                    aria-controls="focus-customer" aria-selected="false">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30"
                                        viewBox="0 0 30 30">
                                        <g>
                                            <path fill-rule="evenodd" clip-rule="evenodd"
                        ...
                        <div class="tab-content" id="pills-tab3Content">
                            <div class="tab-pane fade show active" id="mission" role="tabpanel">
                                Etiam ac tortor id purus commodo vulputate.
                                Vestibulum
                                porttitor erat felis and sed vehicula tortor
                                malesuada
                                gravida. Mauris volutpat enim quis pulv gont
                                congue.
                                Suspendisse ullamcorper, enim vitae
                                tristique blandit, eratot
                                augue torel tempo libero, non porta lectus
                                tortor et elit.
                                Quisque finibusot enim et eratourgt gravida,
                                eu elementum
                                turpis lacinia. Integer female go tellus
                                ligula, attendora and
                                condimentum.
                            </div>
                        ...
                        <div class="about-content-bottom">
                            <a href="{{ route('about') }}" class="primary-btn1">More
                                About</a>
                        </div>
                    </div>
                </div>
                <div class="col-lg-6 d-flex justify-content-end">
                    <div class="about-img">
                        <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1/about-img.png"
                            alt />
                        <img src="https://demo-egenslab.b-cdn.net/html/triprex/preview/assets/img/home1//vector/about-img-bg-vector.svg"
                            alt class="vector" />
                    </div>
                </div>
            </div>
